...
\item resource- and labor-intensity (digital experiments can be easily automated).
\end{itemize}
...
In this system, a population of ten thousand can undergo approximately twenty thousand generations (or about two hundred million individual replication cycles) per day \citep{ofria2009artificial}.
...
Likewise, in Ratcliff’s work studying the evolution of multicellularity in \texit{S. cerevisiae}, about six doublings per day occur among a population numbering on the order of a billion cells \citep{ratcliff2012experimental}.
...
This typically involves independent evaluation of sub-populations (i.e., island models) or individuals (i.e., primary-subordinate or controller-responder parallelism \citep{cantu2001master}).
...
We argue that, in a manner explicitly accommodating capabilities and limitations of available hardware, open-ended artificial life systems should prioritize dynamic interactions between simulation elements situated across physically distributed hardware components.
...
Many of the important natural phenomena, including ecologies, co-evolutionary dynamics, and social behavior, all arise from dynamic interactions among individuals.
...
A best-effort communication model could enable maximization of available bandwidth while avoiding scaling issues typically associated with communication-intensive distributed computing.
...
As mentioned earlier, the contributions of Goldsby and collaborators are particularly notable among computational artificial life work on the origins of multicellularity.
