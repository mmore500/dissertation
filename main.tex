...
\bibliography{
  ch/body/case-studies/bibl.bib,
  ch/body/conclusion/bibl.bib,
  ch/body/influencing-cna/bibl.bib,
  ch/body/infrastructure/bibl.bib,
  ch/body/introduction/bibl.bib,
  ch/body/measuring-cna/bibl.bib
} %your bib file here
\end{singlespace}
\end{doublespace}
\end{document}
