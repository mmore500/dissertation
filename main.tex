...
\bibliography{
  tex/body/case-studies/bibl.bib,
  tex/body/conclusion/bibl.bib,
  tex/body/influencing-cna/bibl.bib,
  tex/body/infrastructure/bibl.bib,
  tex/body/introduction/bibl.bib,
  tex/body/measuring-cna/bibl.bib
} %your bib file here
\end{singlespace}
\end{doublespace}
\end{document}
