...
\bibliography{
  tex/body/1-introduction/bibl.bib,
  tex/body/2-system/bibl.bib,
  tex/body/3-case-studies/bibl.bib,
  tex/body/4-complexity-novelty-adaptation/bibl.bib,
  tex/body/5-event-driven/bibl.bib,
  tex/body/6-conclusion/bibl.bib
} %your bib file here
\end{singlespace}
\end{doublespace}
\end{document}
