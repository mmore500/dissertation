...
\titleformat{\chapter}
  {\normalfont\fontsize{14}{15}\selectfont\bfseries\centering}{\chaptername{} \thechapter}{1em}{}
...
% apply page style within all sideways tables
\BeforeBeginEnvironment{landscape}{
...
\newenvironment{lstinputlistinghandle}{}{\originalclearpage}
\surroundwithmdframed[
  hidealllines=true,
  middleextra={
